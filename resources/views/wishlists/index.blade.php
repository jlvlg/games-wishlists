<x-app-layout>
    <x-slot name="header">
        ...
        <form :action="route('wishlists.index')" class="flex items-center flex-1 rounded-lg bg-gray-800 text-gray-400 border border-gray-500 mx-5" method="get">
            ...
            <input type="search" class="flex-1 border-none bg-transparent focus:border-none focus:ring-0" name="q" id="search" placeholder="Search wishlists" value={{(request()->has('q')) ? request()->input('q') : ''}}>
